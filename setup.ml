...
(* OASIS_START *)
(* DO NOT EDIT (digest: 26a1d6f77d1f9501ab0033e61469331b) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_spreadsheet", []))];
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ...
                           InternalExecutable "test_spreadsheet"
                        ]
                   })
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "F&ê\157\004\\Pê\130 \025\154:-×9";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
