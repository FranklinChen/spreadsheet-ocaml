...
(* OASIS_START *)
(* DO NOT EDIT (digest: b6c590bb16cff8f5022bdf8d5fa93bd6) *)
(*
...
let setup_t =
  {
     ...
     test =
       [
          ("test_acme_spreadsheet",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_acme_spreadsheet", []))];
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/FranklinChen/spreadsheet-ocaml";
          synopsis = "Spreadsheet demo";
          description = Some [OASISText.Para "Spreadsheet demo"];
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Spreadsheet"; "DefaultSpreadsheet"];
                      lib_pack = false;
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for Spreadsheet";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/FranklinChen/spreadsheet-ocaml.git";
                      src_repo_browser =
                        Some
                          "https://github.com/FranklinChen/spreadsheet-ocaml";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "acme_spreadsheet";
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ...
                           InternalExecutable "test_acme_spreadsheet"
                        ]
                   })
            ];
          plugins =
     ...
     oasis_version = "0.4.6";
     oasis_digest =
       Some "3\1934\159\133\002\190\149\213\163\002\220\172\181\020Y";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
